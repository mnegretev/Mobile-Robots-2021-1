...
def get_smooth_path(original_path, alpha, beta):
    ...
    while gradient_mag>tolerance:
        ...
        gradient[len(smooth_path)-1][0] = alpha*(smooth_path[len(smooth_path)-1][0]-original_path[len(smooth_path)-1][0])+beta*(smooth_path[len(smooth_path)-1][0]-smooth_path[len(smooth_path)-1-1][0])
        gradient[len(smooth_path)-1][1] = alpha*(smooth_path[len(smooth_path)-1][1]-original_path[len(smooth_path)-1][1])+beta*(smooth_path[len(smooth_path)-1][1]-smooth_path[len(smooth_path)-1-1][1])


        smooth_path[len(smooth_path)-1][0]=smooth_path[len(smooth_path)-1][0]-epsilon*(alpha*(smooth_path[len(smooth_path)-1][0]-original_path[len(smooth_path)-1][0])+beta*(smooth_path[len(smooth_path)-1][0]-smooth_path[len(smooth_path)-1-1][0])) 
        smooth_path[len(smooth_path)-1][1]=smooth_path[len(smooth_path)-1][1]-epsilon*(alpha*(smooth_path[len(smooth_path)-1][1]-original_path[len(smooth_path)-1][1])+beta*(smooth_path[len(smooth_path)-1][1]-smooth_path[len(smooth_path)-1-1][1]))

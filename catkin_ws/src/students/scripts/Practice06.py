...
Mobile-Robots-2021-1/catkin_ws/src/students/scripts/practice06.py /
@ezioAmalfi
ezioAmalfi Practice06 Terminada
Latest commit 2005781 4 days ago
History
1 contributor
208 lines (193 sloc) 8.23 KB
#!/usr/bin/env python
#
...
def calculate_control(robot_x, robot_y, robot_a, goal_x, goal_y):
    ...
    cmd_vel.angular.x = w_max*(2/(1+math.exp(-error_a/beta))-1)
    return cmd_vel
...
def callback_pot_fields_goal(msg):
    ...
    math.sqrt((goal_x - robot_x)**2 + (goal_y - robot_y)**2)
    tolerance = 0.1
    epsilon = 0.5
    while distance_to_goal_point > tolerance and not rospy.is_shutdown():

...
def segment_by_color(img_bgr, points):
    ...
    color_d = numpy.array([15,153,130], numpy.uint8) #Naranja oscuro
    color_l = numpy.array([16,211,255], numpy.uint8) #Naranja claro

    mask = cv2.inRange(HSVimg,color_d,color_l)
